                        ...
                        for (var j = 0; j < candidate.length; j++) {
                            ...
                            if (this.isRemovable(candid_candidate)) {
                                ...
                                if (this.needsEtcSign(active_index, farthest_index - 1)) {
                                    this.els.eq(farthest_index - 2).before("<li class='disabled removable page-link'><span>...</span></li>");
                                }
                                if (this.needsEtcSign(1, active_index)) {
                                    this.els.eq(1).after("<li class='disabled removable page-link'><span>...</span></li>");
                                }
                                return true;
                            }
                        }
